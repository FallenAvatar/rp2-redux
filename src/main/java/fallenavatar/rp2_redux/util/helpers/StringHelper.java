...
public final class StringHelper {
    ...
    public static IFormattableTextComponent getFluidName(FluidStack stack) {
		...
		case COMMON:
			name = name.withStyle(TextFormatting.WHITE);
			break;
		case UNCOMMON:
			name = name.withStyle(TextFormatting.YELLOW);
			break;
		case RARE:
			name = name.withStyle(TextFormatting.AQUA);
			break;
		case EPIC:
			name = name.withStyle(TextFormatting.LIGHT_PURPLE);
			break;
        }
        return name;
    }
