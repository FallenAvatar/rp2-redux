package fallenavatar.rp2_redux.lib.network.packet.client;
...
import fallenavatar.rp2_redux.lib.util.Utils;
...
public class TileGuiPacket extends PacketBase implements IPacketClient {
    ...
    public static void sendToClient(BaseTile tile, ServerPlayerEntity player) {
