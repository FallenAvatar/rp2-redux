...
public abstract class RP2RecipeCategory<T extends RP2Recipe> implements IRecipeCategory<T> {
    ...
    public RP2RecipeCategory(IGuiHelper guiHelper, ItemStack icon, ResourceLocation uid) {
        this.uid = uid;
