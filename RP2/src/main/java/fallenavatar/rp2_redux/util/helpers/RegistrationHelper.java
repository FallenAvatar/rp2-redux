...
public class RegistrationHelper {
    ...
    public static void registerMetalSet(String prefix, ItemGroup group, Rarity rarity, boolean vanilla) {
        ...
        if (!vanilla) {
            ITEMS.register(prefix + "_ingot", () -> new Item(new Item.Properties().group(group).rarity(rarity)));
            ITEMS.register(prefix + "_nugget", () -> new Item(new Item.Properties().group(group).rarity(rarity)));
        }
    ...
    public static void registerGemSet(String prefix, ItemGroup group, Rarity rarity, boolean vanilla) {
        if (!vanilla) {
            ITEMS.register(prefix, () -> new Item(new Item.Properties().group(group).rarity(rarity)));
        }
    ...
    public static void registerDustSet(String prefix, ItemGroup group, Rarity rarity, boolean vanilla) {
        ITEMS.register(prefix+"_dust", () -> new Item(new Item.Properties().group(group).rarity(rarity)));
