...
// Ripped straight from https://github.com/KingLemming/1.16/blob/master/CoFHCore/src/main/java/cofh/core/util/helpers/StringHelper.java
...
public final class StringHelper {
    ...
    public static IFormattableTextComponent getFluidName(FluidStack stack) {
		...
		case COMMON:
			name = name.mergeStyle(TextFormatting.WHITE);
			break;
		case UNCOMMON:
			name = name.mergeStyle(TextFormatting.YELLOW);
			break;
		case RARE:
			name = name.mergeStyle(TextFormatting.AQUA);
			break;
		case EPIC:
			name = name.mergeStyle(TextFormatting.LIGHT_PURPLE);
			break;
        }
        return name;
    }
